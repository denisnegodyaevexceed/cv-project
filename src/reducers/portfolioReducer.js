const initialState = {
    firstProject: {
        ...
        whatYouDo: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud',
        stack: 'js,js,js,js',
    },
    secondProject: {
        name: 'project name',
