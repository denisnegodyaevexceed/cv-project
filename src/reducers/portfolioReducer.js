const initialState = {
    firstProject: {
        name: 'sdfdsfds',
        link: 'http://localhost:3000/template2',
        summary: '"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ',
        whatYouDo: '"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ',
        stack: [  { title: 'Z shell' },
        { title: 'Html' },
        { title: 'CSS' },
        { title: 'Redux' },],
