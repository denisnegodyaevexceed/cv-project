        ...
        <div className="button5">
          ...
          <Tooltip title="Save template">
                  <Button
                    ...
                    className="k-button"
                    onClick={() => {
                      saveTemplate(4, userInfo, addTechArr, userInfoPortfolio, userAboutHardSkills,userWorkHistory, customizedTemplateUid,allCustomizedTemplateActions, disp,handleUploadAvatar);
                    }}
                  >
